...
public enum HttpExceptionCode {
    ...
    EMAIL_FAILED(HttpStatus.BAD_REQUEST, "이메일 인증 코드가 올바르지 않습니다."),
    ...
    COMMENT_UPDATE_UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "댓글 수정 권한이 없습니다."),
    ...
    UPDATE_FAILED(HttpStatus.UNAUTHORIZED, "수정 중 오류가 발생하였습니다."),
    DELETE_FAILED(HttpStatus.UNAUTHORIZED, "삭제 중 오류가 발생하였습니다."),
